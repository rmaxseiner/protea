...
**Files:**
- `src/protea/web/templates/location.html` - NEW: Location detail template
- `src/protea/web/routes/pages.py` - Location routes
- `src/protea/web/templates/browse.html` - Clickable location headers
- `src/protea/web/templates/bin.html` - Updated breadcrumbs
- `src/protea/web/templates/item.html` - Updated breadcrumbs
...
**File Changed:**
- `src/protea/tools/search.py` - Added child bin recursion in `list_items()`
...
| File | Change |
|------|--------|
| `src/protea/web/templates/quick_add.html` | NEW: Quick add sub-bins page |
| `src/protea/web/templates/location.html` | NEW: Location detail page |
| `src/protea/web/routes/pages.py` | Quick add routes, location routes, download zip |
| `src/protea/web/templates/browse.html` | Clickable location headers |
| `src/protea/web/templates/bin.html` | Quick Add button, auto-upload photos |
| `src/protea/web/templates/item.html` | Breadcrumb links to location |
| `src/protea/web/static/app.css` | Mobile font scaling |
| `.gitea/workflows/build-container.yml` | Automated deployment step |
| `src/protea/tools/search.py` | Fix include_children for bin_id filtering |
