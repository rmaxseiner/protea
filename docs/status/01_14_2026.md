...
- Container registry: `git.maxseiner.casa/ron-maxseiner/protea:latest`

### MCP SSE Endpoint
- New entry point: `protea-sse` on port 8081
...
| File | Change |
|------|--------|
| `src/protea/__init__.py` | Version bump to 0.2.1 |
| `src/protea/config.py` | MCP SSE settings, 15MB max image |
| `src/protea/mcp_sse.py` | NEW: SSE server |
| `src/protea/server.py` | Removed 6 image tools |
| `src/protea/web/app.py` | Added version to templates |
| `src/protea/web/static/app.js` | Lightbox, touch handlers |
| `src/protea/web/static/app.css` | Touch improvements |
| `src/protea/web/templates/base.html` | Version in sidebar |
| `src/protea/web/templates/bin.html` | Lightbox, breadcrumbs |
| `src/protea/web/templates/item.html` | Lightbox, path links |
