...
| File | Change |
|------|--------|
| `src/protea/web/templates/browse.html` | Collapsible structure, toggles, amber background |
| `src/protea/web/static/app.js` | Toggle functions, localStorage persistence |
| `src/protea/web/static/app.css` | Chevron rotation transition styles |
