# Inventory MCP Server - Technical Specification
...
```python
# src/inventory_mcp/db/models.py
...
```python
# src/inventory_mcp/services/image_store.py
...
```python
# src/inventory_mcp/db/connection.py
...
[project.scripts]
inventory-mcp = "inventory_mcp.server:main"
...
4. Run migrations: `inventory-mcp --migrate` (or auto on first run)
